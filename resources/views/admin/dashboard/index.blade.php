                    ...
                    <div class="card-body">
                        ...
                        <div class="direct-chat-contacts">
                            <ul class="contacts-list">
                                <li>
                                    <a href="#">
                                        <img class="contacts-list-img" src="/theme/img/user1-128x128.jpg" alt="User Avatar">
                          ...
                          <span class="contacts-list-name">
                            ...
                            <small class="contacts-list-date float-right">2/28/2015</small>
                                ...
                                <li>
                                    <a href="#">
                                        <img class="contacts-list-img" src="/theme/img/user7-128x128.jpg" alt="User Avatar">
                          ...
                          <span class="contacts-list-name">
                            ...
                            <small class="contacts-list-date float-right">2/23/2015</small>
                                ...
                                <li>
                                    <a href="#">
                                        <img class="contacts-list-img" src="/theme/img/user3-128x128.jpg" alt="User Avatar">
                          ...
                          <span class="contacts-list-name">
                            ...
                            <small class="contacts-list-date float-right">2/20/2015</small>
                                ...
                                <li>
                                    <a href="#">
                                        <img class="contacts-list-img" src="/theme/img/user5-128x128.jpg" alt="User Avatar">
                          ...
                          <span class="contacts-list-name">
                            ...
                            <small class="contacts-list-date float-right">2/10/2015</small>
                                ...
                                <li>
                                    <a href="#">
                                        <img class="contacts-list-img" src="/theme/img/user6-128x128.jpg" alt="User Avatar">
                          ...
                          <span class="contacts-list-name">
                            ...
                            <small class="contacts-list-date float-right">1/27/2015</small>
                                ...
                                <li>
                                    <a href="#">
                                        <img class="contacts-list-img" src="/theme/img/user8-128x128.jpg" alt="User Avatar">
